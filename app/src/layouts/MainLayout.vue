...
const ic = {
  ...
  board: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="2.5" width="12" height="11" rx="1.5"/><line x1="2" y1="6" x2="14" y2="6"/><line x1="6" y1="6" x2="6" y2="13.5"/></svg>',
...
const primaryNav = computed(() => [
  ...
  { name: 'discover', label: 'Discover', icon: ic.search, badge: '' },
  {
    ...
    label: 'Job Board',
    icon: ic.board,
    badge: store.visibleJobs.length ? String(store.visibleJobs.length) : '',
  },
  {
    name: 'starred',
    label: 'Starred',
    icon: ic.star,
    badge: store.starredCount ? String(store.starredCount) : '',
  },
